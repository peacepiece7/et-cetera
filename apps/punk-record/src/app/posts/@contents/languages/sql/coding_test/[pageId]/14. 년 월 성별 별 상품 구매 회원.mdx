export const METADATA = {
  title: "blog | 년 월 성별 별 상품 구매 회원",
  description: "년 월 성별 별 상품 구매 회원",
  date: "",
  tags: [],
...
group by로 년, 월, 성별 별로 집계하면 된다.\
예전에 left join으로 떡칠된 코드를 본적이 잇는데\
이번에 써보니까 left join이 빈 테이터를 체크하는데 유용할 것 같다는 생각을 했다.
