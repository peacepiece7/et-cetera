export const METADATA = {
  title: "blog | 가격대 별 상품 개수 구하기",
  description: "가격대 별 상품 개수 구하기",
  date: "",
  tags: [],
...
mysql은 `floor(price , 4)`이 지원이 안되서 고민하다가\
`(price - mod(price, 10000)) as price_group` 이 부분이 생각이 안나서\
`floor(price / 10000) as price_group` 이렇게 해놓고 조회할 때 10000을 곱해줬다.. ㅋㅋ\
