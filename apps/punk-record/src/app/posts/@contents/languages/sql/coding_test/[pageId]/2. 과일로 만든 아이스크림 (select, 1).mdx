export const METADATA = {
  title: "blog | 과일로 만든 아이스크림",
  description: "과일로 만든 아이스크림",
  date: "",
  tags: [],
...
특정 판매량 이상, 과일 아이스크림을 조회하는 문제\
join을 사용해서 풀었고, nested query로 푼 사람도 있었음
...
인라인 뷰로 해결한 사람도 있음\
(gpt 물어보니까 서브쿼리가 in 절이 많아지면 join 보다 성능이 떨어질 수 있다고 함)
