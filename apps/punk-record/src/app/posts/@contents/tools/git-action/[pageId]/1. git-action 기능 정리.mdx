export const METADATA = {
  title: "blog | 1. git-action 기능 정리",
  description: "1. git-action 기능 정리",
  date: "",
  tags: [],
...
<MDXImage src="/images/git-action-1.png" width={300} className="m-2" />
...
<MDXImage src="/images/git-action-2.png" width={300} className="m-2" />
...
<MDXImage src="/images/git-action-3.png" width={300} className="m-2" />
...
<MDXImage src="/images/git-action-5.png" width={300} className="m-2" />

<MDXImage src="/images/git-action-4.png" width={300} className="m-2" />
